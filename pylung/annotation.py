'''
@Date: 2020-02-15 18:53:44
@LastEditors: Laurence Yu
@LastEditTime: 2020-03-03 02:58:09
@Description:  Modify from Github: https://github.com/zhwhong/lidc_nodule_detection
               These code use for analysis xml file to pkl for patient
'''
...
if __name__ == '__main__':
    ...
    # parse_dir('../LIDC-IDRI/LIDC-IDRI-0905/01-01-2000-1-07760/30376-53756')
    # parse_dir('d:/MyLab/GraduateProject/LIDC-IDRI/LIDC-IDRI-0163/01-01-2000-CT THORAX WCONTRAST-52456/3-Recon 2 CHEST-54230/')
    # pklPath = 'd:/MyLab/GraduateProject/LIDC-IDRI/LIDC-IDRI-0163/01-01-2000-CT THORAX WCONTRAST-52456/3-Recon 2 CHEST-54230/annotation_flatten.pkl'
    # pklPath = 'd:\\MyLab\\GraduateProject\\LIDC-IDRI\\LIDC-IDRI-0198\\01-01-2000-CT THORAX WCONTRAST-08033\\2-CHEST-32481\\annotation_flatten.pkl'
    # pklPath = 'd:\\MyLab\\GraduateProject\\LIDC-IDRI\\LIDC-IDRI-0198\\01-01-2000-CT THORAX WCONTRAST-08033\\2-CHEST-32481\\dicoms_detail.pkl'
    f = open(pklPath, 'rb')
    annotationInfo = cPickle.load(f)

    for info in annotationInfo:
        print(info)
        # for doctor in info:
        #     print(doctor)
